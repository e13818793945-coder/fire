...
- **代理人**：录入自有存量客户 → 系统自动生成 KYC 报告；双周提交经营动态（含新单件数/保费/FYC/转介绍数量）；查看教练反馈；查看集中辅导会总结、盘客报告；查看个人成长报告，报告页顶部有系统实时算的「五维数据总览」雷达图（客户经营能力/KYC应用能力/活动量达成/业绩转化能力/转介绍开发），仅供本人参考，不是项目经理的最终评分
- **教练**：查看学员经营动态，提交诊断反馈
